...
public class Board {
    ...
    public Board() {
        ...
        places.add(new FreeParking(2, "Community Chest 1"));
        ...
        places.add(new FreeParking( 7, "Chance 1"));
        ...
        places.add(new FreeParking(10 , "Jail – Just Visiting"));
        ...
        places.add(new FreeParking(17 , "Community Chest 2"));
        ...
        places.add(new FreeParking(30 , "Go to Jail"));
        ...
        places.add(new FreeParking(33 , "Community Chest 3"));
        ...
        places.add(new FreeParking( 36, "Chance 3"));
        places.add(new Property(37 , "Park Place", 350, new float[]{35, 175, 500, 1100, 1300, 1500}, 175, 200, "Blue"));
        places.add(new Tax( 38, "Luxury Tax", 75));
        places.add(new FreeParking(39 , "Luxury Tax"));
      //  places.add(new Property(70 , "Boardwalk", 400, new float[]{50, 200, 600, 1400, 1700, 2000}, 200, 200, "Blue"));
        places.add(new FreeParking(40 , "Go")); // o go é a posição 40!
    }
